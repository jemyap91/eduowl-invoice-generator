...
SELECT throws_ok(
  $$ SELECT tm_save_assignment('{"code":"X01","tutor_id":"e0000000-0000-0000-0000-000000000001","student_id":"f0000000-0000-0000-0000-000000000001","subject":"Math"}', '[{"label":"1 to 1","parent_rate":70,"tutor_rate":50,"sort_order":0}]') $$,
...
SELECT throws_ok(
  $$ SELECT tm_save_assignment('{"code":"X01","tutor_id":"e0000000-0000-0000-0000-000000000001","student_id":"f0000000-0000-0000-0000-000000000001","subject":"Math"}', '[]') $$,
  '22023', NULL, 'an assignment needs at least one tier');
SELECT throws_ok(
  $$ SELECT tm_save_assignment('{"code":"X01","tutor_id":"e0000000-0000-0000-0000-000000000001","student_id":"f0000000-0000-0000-0000-000000000001","subject":"Math"}', '[{"label":"Group","parent_rate":80,"tutor_rate":50,"sort_order":0},{"label":"Group","parent_rate":90,"tutor_rate":60,"sort_order":1}]') $$,
  '22023', NULL, 'rate tier labels must be unique');
SELECT throws_ok(
  $$ SELECT tm_save_assignment('{"code":"X01","tutor_id":"e0000000-0000-0000-0000-000000000001","student_id":"f0000000-0000-0000-0000-000000000001","subject":"Math"}', '[{"label":"","parent_rate":80,"tutor_rate":50,"sort_order":0}]') $$,
  '22023', NULL, 'every rate tier needs a label');

CREATE TEMP TABLE ids (id UUID);
INSERT INTO ids SELECT tm_save_assignment(
...
SELECT lives_ok(format(
  $$ SELECT tm_save_assignment('{"code":"X01","tutor_id":"e0000000-0000-0000-0000-000000000001","student_id":"f0000000-0000-0000-0000-000000000001","subject":"Math","status":"paused"}', '[{"label":"Group","parent_rate":90,"tutor_rate":55,"sort_order":0},{"label":"Zoom","parent_rate":50,"tutor_rate":40,"sort_order":1}]', '%s') $$,
